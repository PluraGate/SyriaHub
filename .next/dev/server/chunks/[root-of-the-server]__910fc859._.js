...
"[project]/RiderProjects/SyriaHub/app/api/search/suggestions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        if (error) {
            ...
            const { data: fallbackData } = await supabase.from('posts').select('id, title, content').eq('status', 'published').ilike('title', `%${query}%`).limit(5);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__910fc859._.js.map